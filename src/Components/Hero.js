export default function Hero() {
  return (
    <section id='hero' class='text-center bg-illustration-hero-left'>
      <h1>
        Get paid for the work you <span class='text-primary'>love</span> to do.
      </h1>
      <p class='text-gray opacity-50'>
